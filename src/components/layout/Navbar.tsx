...
const navLinks = [
  ...
  { name: "News", path: "/news" },
  { name: "About Web", path: "/about-web" },
  { name: "About Us", path: "/about" },
];

const socialLinks = [
  { 
    icon: WhatsAppIcon, // <-- Use the custom SVG component here
          ...
          <div className="hidden lg:flex items-center gap-8">
            {navLinks.map((link) => (
              <Link
                key={link.path}
                to={link.path}
                className={`relative py-2 text-sm font-medium transition-colors duration-300 link-underline ${
